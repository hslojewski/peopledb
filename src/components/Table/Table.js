...
function Table() {
  const [people, setPeople] = useState([]),
        ...
        [formErrors, setFormErrors] = useState({required:[],format:[]});
  ...
  var savePeopleForm = (e) => {
    ...
    console.log(blah);
    editRecord("People", {fields: blah}, e.target.id);
    setEditMode(null);
  };
  ...
  var savePeopleNoteForm = (e) => {
    ...
    console.log(blah);
      // debugger;
    editRecord("PeopleNotes", {fields: blah}, e.target.id);
    setEditMode(null);
  };
  ...
  var createPerson = (e) => {
    ...
    console.log(blah);
    createRecord("People", {fields: blah});
    // setEditMode(null);
  };
  ...
  var createNote = (e) => {
    ...
    console.log(blah);
    createRecord("PeopleNotes", {fields: blah});
    // setEditMode(null);
  };
                  ...
                  {!!personNotes.length && !!isNotesVisible &&
                    ...
                    <form key="new-note" id="new-note" className="row">
                      ...
                      <div className="col col-1">
                        <a type="submit" onClick={createNote} className="btn btn-primary">
